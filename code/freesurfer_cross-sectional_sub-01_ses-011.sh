...
#SBATCH --job-name=freesurfer_cross-sectional_sub-01_ses-011.job
#SBATCH --output=./code/freesurfer_cross-sectional_sub-01_ses-011.out
#SBATCH --error=./code/freesurfer_cross-sectional_sub-01_ses-011.err
