...
#SBATCH --output=/lustre04/scratch/bpinsard/anat.freesurfer_longitudinal/code/freesurfer_cross-sectional_sub-05_ses-003.out
#SBATCH --error=/lustre04/scratch/bpinsard/anat.freesurfer_longitudinal/code/freesurfer_cross-sectional_sub-05_ses-003.err
...
datalad containers-run -m 'fMRIPrep_sub-05/ses-003' -n containers/bids-freesurfer --output . --input 'sourcedata/cneuromod.anat/sub-05/ses-003/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat/sub-05/ses-003/anat/*_T2w.nii.gz' --input 'sourcedata/cneuromod.anat/sub-05/ses-003/anat/*_FLAIR.nii.gz' -- sourcedata/cneuromod.anat ./ participant --steps cross-sectional --refine_pial --reconstruction_label norm --refine_pial_reconstruction_label norm --hires_mode enable --participant_label 05 --session_label 003 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
freesurfer_exitcode=$?
