...
#SBATCH --job-name=freesurfer_cross-sectional_autorecon1_sub-05_ses-003.job
#SBATCH --output=./code/freesurfer_cross-sectional_autorecon1_sub-05_ses-003.out
#SBATCH --error=./code/freesurfer_cross-sectional_autorecon1_sub-05_ses-003.err
