...
#SBATCH --job-name=freesurfer_cross-sectional_autorecon1_sub-03_ses-005.job
#SBATCH --output=./code/freesurfer_cross-sectional_autorecon1_sub-03_ses-005.out
#SBATCH --error=./code/freesurfer_cross-sectional_autorecon1_sub-03_ses-005.err
