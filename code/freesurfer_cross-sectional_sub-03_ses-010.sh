...
#SBATCH --output=/home/basile/data/tests/anat.freesurfer_longitudinal/code/freesurfer_cross-sectional_sub-03_ses-010.out
#SBATCH --error=/home/basile/data/tests/anat.freesurfer_longitudinal/code/freesurfer_cross-sectional_sub-03_ses-010.err
