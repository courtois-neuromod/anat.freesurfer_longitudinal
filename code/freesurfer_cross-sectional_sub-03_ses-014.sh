...
#SBATCH --job-name=freesurfer_cross-sectional_sub-03_ses-014.job
#SBATCH --output=./code/freesurfer_cross-sectional_sub-03_ses-014.out
#SBATCH --error=./code/freesurfer_cross-sectional_sub-03_ses-014.err
