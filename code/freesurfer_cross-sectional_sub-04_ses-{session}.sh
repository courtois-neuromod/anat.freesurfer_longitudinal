...
#SBATCH --job-name=freesurfer_cross-sectional_sub-04_ses-{session}.job
#SBATCH --output=/lustre04/scratch/bpinsard/anat.freesurfer_longitudinal/code/freesurfer_cross-sectional_sub-04_ses-{session}.out
#SBATCH --error=/lustre04/scratch/bpinsard/anat.freesurfer_longitudinal/code/freesurfer_cross-sectional_sub-04_ses-{session}.err
