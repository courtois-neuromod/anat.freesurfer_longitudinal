...
#SBATCH --job-name=freesurfer_cross-sectional_autorecon3_sub-04_ses-002.job
#SBATCH --output=./code/freesurfer_cross-sectional_autorecon3_sub-04_ses-002.out
#SBATCH --error=./code/freesurfer_cross-sectional_autorecon3_sub-04_ses-002.err
