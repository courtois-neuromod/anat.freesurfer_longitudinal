...
#SBATCH --job-name=freesurfer_cross-sectional_sub-01_ses-013.job
#SBATCH --output=./code/freesurfer_cross-sectional_sub-01_ses-013.out
#SBATCH --error=./code/freesurfer_cross-sectional_sub-01_ses-013.err
