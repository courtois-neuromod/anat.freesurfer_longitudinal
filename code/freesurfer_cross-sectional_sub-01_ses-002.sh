...
datalad containers-run -m 'fMRIPrep_sub-01/ses-002' -n bids-freesurfer --output . --input 'sourcedata/cneuromod.anat.gradcorrect/sub-01/ses-002/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat.gradcorrect/sub-01/ses-002/anat/*_T2w.nii.gz' -- sourcedata/cneuromod.anat.gradcorrect ./ participant --steps cross-sectional --refine_pial T2 --hires_mode enable --participant_label 01 --session_label 002 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
freesurfer_exitcode=$?
