...
#SBATCH --job-name=freesurfer_cross-sectional_autorecon3_sub-03_ses-010.job
#SBATCH --output=./code/freesurfer_cross-sectional_autorecon3_sub-03_ses-010.out
#SBATCH --error=./code/freesurfer_cross-sectional_autorecon3_sub-03_ses-010.err
