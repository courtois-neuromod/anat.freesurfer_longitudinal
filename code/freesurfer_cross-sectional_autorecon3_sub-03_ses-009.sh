...
#SBATCH --job-name=freesurfer_cross-sectional_autorecon3_sub-03_ses-009.job
#SBATCH --output=./code/freesurfer_cross-sectional_autorecon3_sub-03_ses-009.out
#SBATCH --error=./code/freesurfer_cross-sectional_autorecon3_sub-03_ses-009.err
