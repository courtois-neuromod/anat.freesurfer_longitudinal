...
#SBATCH --job-name=freesurfer_cross-sectional_sub-05_ses-010.job
#SBATCH --output=./code/freesurfer_cross-sectional_sub-05_ses-010.out
#SBATCH --error=./code/freesurfer_cross-sectional_sub-05_ses-010.err
