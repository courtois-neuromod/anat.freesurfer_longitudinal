...
#SBATCH --job-name=freesurfer_cross-sectional_autorecon1_sub-02_ses-007.job
#SBATCH --output=./code/freesurfer_cross-sectional_autorecon1_sub-02_ses-007.out
#SBATCH --error=./code/freesurfer_cross-sectional_autorecon1_sub-02_ses-007.err
