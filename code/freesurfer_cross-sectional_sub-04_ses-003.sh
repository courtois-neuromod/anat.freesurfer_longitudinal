...
datalad containers-run -m 'fMRIPrep_sub-04/ses-003' -n bids-freesurfer --output . --input 'sourcedata/cneuromod.anat.gradcorrect/sub-04/ses-003/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat.gradcorrect/sub-04/ses-003/anat/*_T2w.nii.gz' -- sourcedata/cneuromod.anat.gradcorrect ./ participant --steps cross-sectional --refine_pial T2 --hires_mode enable --participant_label 04 --session_label 003 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
freesurfer_exitcode=$?
