...
datalad containers-run -m 'freesurfer_sub-06/ses-012' -n bids-freesurfer --input 'sourcedata/cneuromod.anat.gradcorrect/sub-06/ses-012/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat.gradcorrect/sub-06/ses-012/anat/*_T2w.nii.gz'  --output 'sub-06_ses-012/'  -- sourcedata/cneuromod.anat.gradcorrect ./ participant --steps cross-sectional --stages autorecon1  --hires_mode enable --participant_label 06 --session_label 012 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
datalad remove sub-06_ses-012/mri/brainmask.* || true 
datalad containers-run --input 'sourcedata/cneuromod.anat.gradcorrect/sub-06/ses-012/anat/*_T1w.nii.gz' --input 'sub-06_ses-012/mri/T1.mgz' -n brain_xtract . sub-06_ses-012 sourcedata/cneuromod.anat.gradcorrect/sub-06/ses-012/anat/*_T1w.nii.gz 
datalad containers-run -m 'freesurfer_sub-06/ses-012' -n bids-freesurfer --input 'sourcedata/cneuromod.anat.gradcorrect/sub-06/ses-012/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat.gradcorrect/sub-06/ses-012/anat/*_T2w.nii.gz'  --output 'sub-06_ses-012/' --input 'sub-06_ses-012/' -- sourcedata/cneuromod.anat.gradcorrect ./ participant --steps cross-sectional --stages autorecon2  --hires_mode enable --participant_label 06 --session_label 012 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
