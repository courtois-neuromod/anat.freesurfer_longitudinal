...
#SBATCH --job-name=freesurfer_cross-sectional_sub-02_ses-012.job
#SBATCH --output=./code/freesurfer_cross-sectional_sub-02_ses-012.out
#SBATCH --error=./code/freesurfer_cross-sectional_sub-02_ses-012.err
