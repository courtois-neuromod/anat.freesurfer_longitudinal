...
datalad containers-run --input 'sourcedata/cneuromod.anat.gradcorrect/sub-06/ses-014/anat/*_T1w.nii.gz' --input 'sub-06_ses-014/mri/T1.mgz' -n brain_xtract . sub-06_ses-014 sourcedata/cneuromod.anat.gradcorrect/sub-06/ses-014/anat/*_T1w.nii.gz 
datalad containers-run -m 'freesurfer_sub-06/ses-014' -n bids-freesurfer --input 'sourcedata/cneuromod.anat.gradcorrect/sub-06/ses-014/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat.gradcorrect/sub-06/ses-014/anat/*_T2w.nii.gz'  --output 'sub-06_ses-014/' --input 'sub-06_ses-014/' -- sourcedata/cneuromod.anat.gradcorrect ./ participant --steps cross-sectional --stages autorecon2  --hires_mode enable --participant_label 06 --session_label 014 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
