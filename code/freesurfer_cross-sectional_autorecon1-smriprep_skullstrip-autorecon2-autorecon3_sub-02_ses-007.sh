...
datalad containers-run -m 'freesurfer_sub-02/ses-007' -n bids-freesurfer --input 'sourcedata/cneuromod.anat.gradcorrect/sub-02/ses-007/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat.gradcorrect/sub-02/ses-007/anat/*_T2w.nii.gz'  --output 'sub-02_ses-007/'  -- sourcedata/cneuromod.anat.gradcorrect ./ participant --steps cross-sectional --stages autorecon1  --hires_mode enable --participant_label 02 --session_label 007 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
datalad remove sub-02_ses-007/mri/brainmask.* || true 
datalad containers-run --input 'sourcedata/cneuromod.anat.gradcorrect/sub-02/ses-007/anat/*_T1w.nii.gz' --input 'sub-02_ses-007/mri/T1.mgz' -n brain_xtract . sub-02_ses-007 sourcedata/cneuromod.anat.gradcorrect/sub-02/ses-007/anat/*_T1w.nii.gz 
datalad containers-run -m 'freesurfer_sub-02/ses-007' -n bids-freesurfer --input 'sourcedata/cneuromod.anat.gradcorrect/sub-02/ses-007/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat.gradcorrect/sub-02/ses-007/anat/*_T2w.nii.gz'  --output 'sub-02_ses-007/' --input 'sub-02_ses-007/' -- sourcedata/cneuromod.anat.gradcorrect ./ participant --steps cross-sectional --stages autorecon2  --hires_mode enable --participant_label 02 --session_label 007 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
