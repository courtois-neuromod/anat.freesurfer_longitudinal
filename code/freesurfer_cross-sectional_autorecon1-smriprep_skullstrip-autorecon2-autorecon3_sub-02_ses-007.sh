...
datalad containers-run --input 'sourcedata/cneuromod.anat.gradcorrect/sub-02/ses-007/anat/*_T1w.nii.gz' --input 'sub-{subject}_ses-{session}/mri/T1.mgz' -n brain_xtract . sub-02_ses-007 sourcedata/cneuromod.anat.gradcorrect/sub-02/ses-007/anat/*_T1w.nii.gz 
