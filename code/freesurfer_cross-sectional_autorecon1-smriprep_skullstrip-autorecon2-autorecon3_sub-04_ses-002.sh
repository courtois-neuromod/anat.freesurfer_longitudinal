...
datalad remove sub-04_ses-002/mri/brainmask.*
datalad containers-run -n brain_xtract . sub-04_ses-002 sourcedata/cneuromod.anat.gradcorrect/sub-04/ses-002/anat/*_T1w.nii.gz 
