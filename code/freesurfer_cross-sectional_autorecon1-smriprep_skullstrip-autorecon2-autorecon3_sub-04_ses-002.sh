...
datalad containers-run -m 'freesurfer_sub-04/ses-002' -n bids-freesurfer --input 'sourcedata/cneuromod.anat.gradcorrect/sub-04/ses-002/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat.gradcorrect/sub-04/ses-002/anat/*_T2w.nii.gz'  --output 'sub-04_ses-002/'  -- sourcedata/cneuromod.anat.gradcorrect ./ participant --steps cross-sectional --stages autorecon1  --hires_mode enable --participant_label 04 --session_label 002 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
datalad remove sub-04_ses-002/mri/brainmask.* || true 
datalad containers-run --input 'sourcedata/cneuromod.anat.gradcorrect/sub-04/ses-002/anat/*_T1w.nii.gz' --input 'sub-04_ses-002/mri/T1.mgz' -n brain_xtract . sub-04_ses-002 sourcedata/cneuromod.anat.gradcorrect/sub-04/ses-002/anat/*_T1w.nii.gz 
datalad containers-run -m 'freesurfer_sub-04/ses-002' -n bids-freesurfer --input 'sourcedata/cneuromod.anat.gradcorrect/sub-04/ses-002/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat.gradcorrect/sub-04/ses-002/anat/*_T2w.nii.gz'  --output 'sub-04_ses-002/' --input 'sub-04_ses-002/' -- sourcedata/cneuromod.anat.gradcorrect ./ participant --steps cross-sectional --stages autorecon2  --hires_mode enable --participant_label 04 --session_label 002 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
