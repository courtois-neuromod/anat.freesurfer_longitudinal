...
#SBATCH --output=/home/basile/data/tests/anat.freesurfer_longitudinal/code/freesurfer_cross-sectional_sub-04_ses-001.out
#SBATCH --error=/home/basile/data/tests/anat.freesurfer_longitudinal/code/freesurfer_cross-sectional_sub-04_ses-001.err
