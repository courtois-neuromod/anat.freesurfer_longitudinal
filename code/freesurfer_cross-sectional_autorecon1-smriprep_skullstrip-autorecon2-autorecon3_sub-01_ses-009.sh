...
datalad remove sub-01_ses-009/mri/brainmask.*
datalad containers-run -n brain_xtract . sub-01_ses-009 sourcedata/cneuromod.anat.gradcorrect/sub-01/ses-009/anat/*_T1w.nii.gz 
