...
#SBATCH --output=/lustre04/scratch/bpinsard/anat.freesurfer_longitudinal/code/freesurfer_cross-sectional_sub-01_ses-007.out
#SBATCH --error=/lustre04/scratch/bpinsard/anat.freesurfer_longitudinal/code/freesurfer_cross-sectional_sub-01_ses-007.err
...
datalad containers-run -m 'fMRIPrep_sub-01/ses-007' -n containers/bids-freesurfer --output . --input 'sourcedata/cneuromod.anat/sub-01/ses-007/anat/*_T1w.nii.gz' --input 'sourcedata/cneuromod.anat/sub-01/ses-007/anat/*_T2w.nii.gz' --input 'sourcedata/cneuromod.anat/sub-01/ses-007/anat/*_FLAIR.nii.gz' -- sourcedata/cneuromod.anat ./ participant --steps cross-sectional --refine_pial --reconstruction_label norm --refine_pial_reconstruction_label norm --hires_mode enable --participant_label 01 --session_label 007 --skip_bids_validator --license_file code/freesurfer.license --n_cpus 4 
freesurfer_exitcode=$?
