...
#SBATCH --job-name=freesurfer_cross-sectional_autorecon1_sub-03_ses-001.job
#SBATCH --output=./code/freesurfer_cross-sectional_autorecon1_sub-03_ses-001.out
#SBATCH --error=./code/freesurfer_cross-sectional_autorecon1_sub-03_ses-001.err
